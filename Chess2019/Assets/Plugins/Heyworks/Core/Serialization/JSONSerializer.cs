...
public class JSONSerializer : IDataSerializer
{
    ...
    public object Deserialize(string serializedData, Type type)
    {
        ...
        {
            string message = string.Format("An error has occurred while deserializing data. Error message: {0}, Type: {1}, Data: {2}", ex.Message, type, serializedData);
    ...
    public string Serialize(object obj, Formatting format)
    {
        ...
        {
            string message = string.Format("An error has occurred while serializing object. Error message: {0}, Type: {1}, Object: {2}", ex.Message, obj.GetType(), obj);
